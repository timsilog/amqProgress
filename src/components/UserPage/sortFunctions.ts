...
const byArtist = (a: Progress, b: Progress) => {
  const res = a.songs[0].songArtist > b.songs[0].songArtist ? 1 : -1;
  if (isReversed) {
    return res === 1 ? -1 : 1;
  }
  return res;
...
const byTitle = (a: Progress, b: Progress) => {
  const res = a.songs[0].songName > b.songs[0].songName ? 1 : -1;
  if (isReversed) {
    return res === 1 ? -1 : 1;
  }
  return res;
...
const byAnimeEn = (a: Progress, b: Progress) => {
  const a1 = a.songs[0].anime.english
    ? a.songs[0].anime.english
    : a.songs[0].anime.romaji
      ? a.songs[0].anime.romaji
      : a.songs[0].anime.amq1;
  const b1 = b.songs[0].anime.english
    ? b.songs[0].anime.english
    : b.songs[0].anime.romaji
      ? b.songs[0].anime.romaji
      : b.songs[0].anime.amq1;
...
const byAnimeJp = (a: Progress, b: Progress) => {
  const a1 = a.songs[0].anime.romaji
    ? a.songs[0].anime.romaji
    : a.songs[0].anime.english
      ? a.songs[0].anime.english
      : a.songs[0].anime.amq1;
  const b1 = b.songs[0].anime.romaji
    ? b.songs[0].anime.romaji
    : b.songs[0].anime.english
      ? b.songs[0].anime.english
      : b.songs[0].anime.amq1;
